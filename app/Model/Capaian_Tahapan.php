...
class Capaian_Tahapan extends Model
{
    protected $table = 'siap_kerja_capaian_tahapan';
    public $incrementing = false;
    protected $keyType = 'string';
    public $timestamps = true;
    
    protected $fillable = ['id', 'seksi_id', 'kegiatan_id', 'kegiatan_tahapan_id'
        , 'target_all', 'is_mulai', 'yang_isi', 'bulan_awal', 'bulan_akhir', 'tahun'
    ...
    {
        return $this->hasMany('App\Model\Capaian_Individu', 'capaian_tahapan_id', 'id');
    }
    ...
    public function getCapaianKomulatif01Attribute($value)
    {
        ...
        if($target_kw == 0 && $realisasi_kw == 0){
            return NULL;
        }else if($target_kw == 0 || $realisasi_kw <= 0){
            return 0;
        }
